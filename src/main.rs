...
mod prelude {
    ...
    pub const MOVE_UPLEFT: Point = Point { x: -1, y: -1 };
    pub const MOVE_UPRIGHT: Point = Point { x: 1, y: -1 };
    pub const MOVE_DOWN: Point = Point { x: 0, y: 1 };
    pub const MOVE_DOWNRIGHT: Point = Point { x: 1, y: 1 };
    pub const MOVE_DOWNLEFT: Point = Point { x: -1, y: 0 };
...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        if let Some(VirtualKeyCode::Key1) = ctx.key { // TODO: centralize game build code to single function.
